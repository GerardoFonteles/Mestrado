...
mi1=distancia(x1);   % Pertinencias para variavel VELOCIDADE
mi2=curvatura(angulo);     % Pertinencias para variavel CURVATURA

% Funcoes de Pertinencia (VARIAVEL DE SAIDA)
y=-30:0.1:30;   % Universo de discurso da variavel de saida
mi_out=[];
for i=1:length(y),
