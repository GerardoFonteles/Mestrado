...
#Leitura das imagens
#cameraman = imread('C:/Users/Labvis/Dropbox/mestrado/Processamento Digital de Imagens/Trabalho1/woman_blonde.jpg')
...
for k in range(6):  
    lena_filtrada[:,:,k] = gaussian_laplace(lena, 1.4*k)
    #lena_filtrada[:,:,k] = filters.laplace(lena,3)
    plt.figure(k)
    plt.axis('off')
